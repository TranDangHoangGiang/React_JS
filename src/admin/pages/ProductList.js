...
const ProductList = ({ onPageChange }) => {
  ...
  const handleBulkDelete = () => {
    ...
    console.log("Xóa nhiều sản phẩm:", selectedItems);
    setSelectedItems([]);
  };
  ...
  const confirmDelete = async () => {
    ...
    try {
      // Bước 1: Lấy sản phẩm từ all_products
      ...
      if (!category || !refId) {
        alert("⚠️ Thiếu category hoặc refId trong sản phẩm.");
        return;
      }
              ...
              {filteredProducts.map((product) => (
                <tr key={product.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                    {Math.round(product?.sale_price).toLocaleString("vi-VN")}₫
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
            ...
            <div className="mt-3 text-center">
              ...
              <div className="mt-2 px-7 py-3">
                <p className="text-sm text-gray-500">
                  Bạn có chắc chắn muốn xóa sản phẩm "{productDelete}"? Thao tác
